...
•	Research Question: How can routinely collected maternal and household health indicators be modelled to prioritise pediatric anemia screening in resource-constrained regions?
•	Strategic Shift: Moving from static descriptive reporting to a clinical decision-support framework that identifies the most accurate socio-environmental indicators of child vulnerability.
